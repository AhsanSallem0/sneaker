...
<body style="background: lightgray"  id="body">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 mb-4">
                                <input type="email" class="form-control input-lg @error('email') is-invalid @enderror" name="email" id="email" value="{{ old('email') }}" required autocomplete="email" autofocus aria-describedby="emailHelp" placeholder="Username Email">
...
{{--                                @endif--}}
    ...
    <div class="copyright pl-0">
        <p class="text-center">&copy; 2023 Copyright Sneak Trade</p>
    </div>
</div>
</body>
</html>
